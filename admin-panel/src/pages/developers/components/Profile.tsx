            ...
            <div className="flex flex-col md:flex-row gap-8">
                <div className="w-full md:w-1/3">
                    <div className="relative">
                        ...
                        />
                        <span className={`absolute top-3 right-3 px-3 py-1 rounded-full text-sm font-medium ${levelColors[level]}`}>
                            {level}
                        </span>
                    </div>
                    ...
                    <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center">
                                ...
                                <span className="ml-2 text-lg font-semibold">{rating.avg.toFixed(1)}</span>
                        ...
                        <div className="space-y-2">
                            ...
                            {lastAssignedAt && (
                                <div className="flex justify-between">
                                    <span className="text-gray-600 dark:text-gray-300">Last Project</span>
