...
export const store = configureStore({
    ...
    middleware: (getDefaultMiddleware) => getDefaultMiddleware().concat(authApi.middleware, userApi.middleware, clientApi.middleware, developerApi.middleware, packageApi.middleware, paymentApi.middleware, subscriptionApi.middleware),
});
