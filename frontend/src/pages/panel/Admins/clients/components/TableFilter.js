...
const TableFilter = ({ onFilterChange }) => {
    ...
    const isFiltersActive = filters.search !== '' || filters.status !== '';
    const clearFilters = () => {
        const emptyFilters = {
            search: '',
            status: '',
